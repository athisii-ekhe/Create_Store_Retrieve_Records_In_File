class Stack:
    ...
    def __len__(self):
        """
        Objective: To return the length of stack object.
        Input parameters:
                self: Implicit object of the class Stack.
        Return: Length of stack object.
        """
        return len(self.lst)
...
def main():
    ...
    while True:
        ...
        5. Print the top elements of stack.
        6. Exit""")
        print("==" * 32)
        ...
        if user_choice == '1':
            ...
            print(f'Total element(s):{len(stack)} \n{stack}')
        elif user_choice == '5':
            if stack.is_empty():
                print("Stack is empty!")
                continue
            print(f'Top element of stack:{stack.peek()}')
        elif user_choice == '6':
            print("Exiting....")
            return
        else:
