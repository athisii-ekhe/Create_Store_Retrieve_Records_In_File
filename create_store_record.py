...
def retrieveSomeRecords(user_choice, lower_index, upper_index):
    '''
...
def retrieveSingleRecord(user_choice,record_num):
    '''
...
def main():
    ...
    writeRecordsToFile(total_record)
    makeF1AndF2()
    while True:
        ...
        if user_choice == "1":
            ...
            if choice == '1' or choice == '2':
                ...
                if lower_index <1:
                    ...
                    retrieveSomeRecords(choice,lower_index, upper_index)
            else:
                print("Invalid Input!")
            ...
            if choice == '1' or choice == '2':
                ...
                if record_num <1:
                    ...
                    print()
                    retrieveSingleRecord(choice,record_num)
            else:
                print("Invalid Input!")
